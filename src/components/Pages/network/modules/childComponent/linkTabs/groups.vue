<template>
  <div class="container-section-main">
    <!-- header section-->
    <div class="network__header-main">
      <div class="network__header-title">
