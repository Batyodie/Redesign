<template>
  <section class="header">
    <div class="header__logo">
      <svg width="46" height="46" viewBox="0 0 46 46" class="header__image" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <nav class="main-nav" aria-label="Main">
      <ul class="main-nav__list">
        <li class="main-nav__item">
          <router-link to="/profilePage" class="main-nav__link">
      ...
      <div class="main-nav__profile">
        ...
        <div class="main-nav__profile-container">
          ...
          <div class="main-nav__statics">
            ...
            <span class="main-nav__rating">
          +32 <svg class="rating-icon" width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M3.5 8.50022L8.5 3.50021" stroke="#02B033" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M3.5 3.50021H8.5V8.50022" stroke="#02B033" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
        </span>
          </div>
        </div>
